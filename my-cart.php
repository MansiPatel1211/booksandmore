...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Your Saved Post has been Updated');</script>";
		}
	}
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="#">Home</a></li>
				<li class='active'>Saved Posts</li>
			</ul>
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">My flagged posts</th>
					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Update Save Posts" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
