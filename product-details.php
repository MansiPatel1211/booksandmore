...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Authors Name :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> SAVE</a>
									</div>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Story :</b>  <?php echo htmlentities($rvw['quality']);?> Star</div>
													<div class="text"><b>Plot :</b>  <?php echo htmlentities($rvw['price']);?> Star</div>
													<div class="text"><b>Author :</b>  <?php echo htmlentities($rvw['value']);?> Star</div>
										...
										<div class="product-add-review">
											<h4 class="title">_____________________________</h4>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">SUBMIT</button>
														</div><!-- /.action -->
