...
<html lang="en">
	<head>
	    ...
	    <title>Books and More Home Page</title>
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Recommended Books</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab">Books</a></li>
					<li><a href="#furniture" data-toggle="tab">Movies</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<!--<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Save book</a></div>
			</div><!-- /.product -->
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<!--<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Save</a></div>
			</div>
			</div>
		</div>
<?php }?>
